      ...
      <form onSubmit={onSubmitHandler}>
        ...
        >
          ...
          <TextField
            ...
            helperText={nameHasError ? 'Enter your first name' : ''}
            type='text'
            name='firstName'
            id='name'
            variant='outlined'
          ...
          <TextField
            ...
            helperText={nameHasError ? 'Enter your last name' : ''}
            type='text'
            name='lastName'
            id='name'
            variant='outlined'
          ...
          <TextField
            ...
            helperText={confirmPassword.length > 0 && password !== confirmPassword ? 'Password must match!' : ''}
            type='password'
